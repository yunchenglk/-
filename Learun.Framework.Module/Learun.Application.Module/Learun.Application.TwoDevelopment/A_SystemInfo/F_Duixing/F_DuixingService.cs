...
namespace Learun.Application.TwoDevelopment.A_SystemInfo
{
    ...
    /// 描 述：业务对象信息字典管理
    /// </summary>
    public class F_DuixingService : RepositoryFactory
    {
        #region 获取数据
        ...
        public IEnumerable<A_DuixiangEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                ...
                t.F_CreateUserId
                ");
                strSql.Append("  FROM A_Duixiang t ");
                ...
                return this.BaseRepository().FindList<A_DuixiangEntity>(strSql.ToString(),dp, pagination);
            }
            catch (Exception ex)
            {
        ...
        public A_DuixiangEntity GetA_DuixiangEntity(string keyValue)
        {
            try
            {
                return this.BaseRepository().FindEntity<A_DuixiangEntity>(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                this.BaseRepository().Delete<A_DuixiangEntity>(t=>t.ID == keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
