...
namespace Learun.Application.TwoDevelopment.MY_SystemCode
{
    ...
    /// 描 述：sdfg
    /// </summary>
    public class dgBLL : dgIBLL
    {
        private dgService dgService = new dgService();
        ...
        public IEnumerable<c_ChargecategoryEntity> GetList( string queryJson )
        {
            try
            {
                return dgService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<c_ChargecategoryEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return dgService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public c_ChargecategoryEntity GetEntity(string keyValue)
        {
            try
            {
                return dgService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                dgService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, c_ChargecategoryEntity entity)
        {
            try
            {
                dgService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
